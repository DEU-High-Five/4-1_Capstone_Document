              ...
              <div id="reg_final_description_zone">
                <div style="margin-top:40%">
                  ...
                  <div id="sec1" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="200">
                    <h1 class="bold" style="font-size:30px">기관에 가입되었어요!</h1>
                  </div>
                </div>
                <CButton id="sec1" class="light_dark_shadow" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="400" style="margin-top:20%" size="lg" color="primary" block @click="gotoLogin">내 기관 구경하러 가기</CButton>
              </div>
        </CCol>
      </CRow>
    </CContainer>
